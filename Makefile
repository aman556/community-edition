...
prep-gcp-tanzu-bucket:
	...
	BUILD_EDITION=${BUILD_EDITION} TCE_BUILD_VERSION=$(BUILD_VERSION) \
...
unmanaged-cluster-e2e-test:
	cd cli/cmd/plugin/unmanaged-cluster/test/e2e && BUILD_VERSION=$(BUILD_VERSION) go test -timeout 180m
##### E2E TESTS
