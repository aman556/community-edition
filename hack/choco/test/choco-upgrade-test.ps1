...
gh pr create --repo $TCE_REPO --title "auto-generated - update tce choco install scripts for version $version" --body "auto-generated - update tce choco install scripts for version ${version}xyz"
