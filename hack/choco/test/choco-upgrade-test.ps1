...
gh pr create --repo $TCE_REPO "auto-generated - update tce choco install scripts for version ${version}" --title "auto-generated - update tce choco install scripts for version ${version}" --body $body
