...
git commit -s -m "auto-generated - update tce choco install scripts for version"

git push origin $PR_BRANCH
 
gh pr create --repo $TCE_REPO --title "auto-generated - update tce choco install scripts for version" --body "auto-generated - update tce choco install scripts for version"
